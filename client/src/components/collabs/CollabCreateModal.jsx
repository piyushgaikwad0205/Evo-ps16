...
export default function CollabCreateModal({ isOpen, onClose, onSuccess }) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            <div
                className={`relative w-full max-w-3xl max-h-[90vh] overflow-y-auto ${isDarkMode ? "bg-dark-bg-secondary border-white/10" : "bg-white border-gray-200"} rounded-2xl border-2 shadow-2xl`}
                onClick={(e) => e.stopPropagation()}
            >
                {/* Header */}
                <div className={`sticky top-0 ${isDarkMode ? "bg-dark-bg-secondary border-white/10" : "bg-white border-gray-200"} border-b-2 px-6 py-4 flex items-center justify-between z-10`}>
                    <div>
                    ...
                    <button
                        onClick={handleClose}
                        className={`p-2 rounded-lg ${isDarkMode ? "hover:bg-white/5 text-gray-400 hover:text-white" : "hover:bg-gray-100 text-gray-500 hover:text-gray-900"} transition-colors`}
                    >
                ...
                <div className="px-6 py-6 space-y-5">
                    ...
                    {/* Tips Section */}
                    <div className={`p-4 ${isDarkMode ? "bg-orange-500/10 border-orange-500/20" : "bg-orange-50 border-orange-200"} border-2 rounded-xl`}>
                ...
                {/* Footer Actions */}
                <div className={`sticky bottom-0 ${isDarkMode ? "bg-dark-bg-secondary border-white/10" : "bg-white border-gray-200"} border-t-2 px-6 py-4 flex flex-col sm:flex-row gap-3`}>
                    <button
                        onClick={handleClose}
                        disabled={submitting}
                        className={`flex-1 px-6 py-3 border-2 ${isDarkMode ? "border-white/10 text-white hover:bg-white/5" : "border-gray-200 text-gray-700 hover:bg-gray-50"} rounded-xl transition-all font-bold text-sm ${submitting ? "opacity-50 cursor-not-allowed" : ""}`}
                    >
                        Cancel
                    </button>
                    <button
